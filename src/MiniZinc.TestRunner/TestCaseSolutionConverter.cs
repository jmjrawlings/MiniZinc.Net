...
/// <summary>
/// Turns an expected <see cref="TestCaseSolution"/> (parsed from the libminizinc YAML
...
/// by <see cref="MiniZincDataComparer"/>.
///
/// Implemented as a DZN round-trip (<see cref="TestCaseSolutionDzn.Render"/> →
...
/// </summary>
public static class TestCaseSolutionConverter
{
    /// <summary>
    /// Convert an expected <see cref="TestCaseSolution"/> to <see cref="MiniZincData"/>.
    ...
    public static bool TryFromSolution(
        TestCaseSolution solution,
        out MiniZincData data,
        out string? error
    )
    {
        string? dzn = TestCaseSolutionDzn.Render(solution);
        if (dzn is null)
        {
    ...
    /// </summary>
    public static MiniZincData FromSolution(TestCaseSolution solution)
    {
