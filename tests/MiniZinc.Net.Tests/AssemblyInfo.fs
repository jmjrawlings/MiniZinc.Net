...
[<assembly: AssemblyTitleAttribute("MiniZinc.Net.Tests")>]
[<assembly: AssemblyProductAttribute("MiniZinc.Net")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "MiniZinc.Net.Tests"
    let [<Literal>] AssemblyProduct = "MiniZinc.Net"
