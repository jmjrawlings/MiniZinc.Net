...
//             "TUnit.Core"
//         );
//         Block($"public sealed class {ClassName} : ClientTests");
//         NewLine();
//
...
//         {
//             Attribute("Arguments", $"\"{solver}\"", $"{(enabled ? "true" : "false")}");
//         }
//
//         block = Function($"public async Task {info.Name}", "string solver", "bool enabled");
