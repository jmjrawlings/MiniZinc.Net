public sealed class LexerIntegrationTests {
	...
	[Fact(DisplayName = "unit/general/assert_bad_1.mzn")]
	public void test_unit_general_assert_bad_1() {
		var path = "unit/general/assert_bad_1.mzn";
		Test(path);
	}

	[Fact(DisplayName = "unit/general/assert_bad_2.mzn")]
	...
	[Fact(DisplayName = "unit/general/test_array1d_bad_1.mzn")]
	public void test_unit_general_test_array1d_bad_1() {
		var path = "unit/general/test_array1d_bad_1.mzn";
		Test(path);
	}

	[Fact(DisplayName = "unit/general/test_array1d_bad_2.mzn")]
	public void test_unit_general_test_array1d_bad_2() {
		var path = "unit/general/test_array1d_bad_2.mzn";
		Test(path);
	}

	[Fact(DisplayName = "unit/general/test_array1d_bad_3.mzn")]
	public void test_unit_general_test_array1d_bad_3() {
		var path = "unit/general/test_array1d_bad_3.mzn";
		Test(path);
	}

	[Fact(DisplayName = "unit/general/test_array1d_bad_4.mzn")]
	public void test_unit_general_test_array1d_bad_4() {
		var path = "unit/general/test_array1d_bad_4.mzn";
		Test(path);
	}
	...
	[Fact(DisplayName = "unit/general/test_bad_array_size-bad.mzn")]
	public void test_unit_general_test_bad_array_size_bad() {
		var path = "unit/general/test_bad_array_size-bad.mzn";
		Test(path);
	}
	...
	[Fact(DisplayName = "unit/general/test_negated_let_bad.mzn")]
	public void test_unit_general_test_negated_let_bad() {
		var path = "unit/general/test_negated_let_bad.mzn";
		Test(path);
	}
	...
	[Fact(DisplayName = "unit/general/test_reified_let_bad.mzn")]
	public void test_unit_general_test_reified_let_bad() {
		var path = "unit/general/test_reified_let_bad.mzn";
		Test(path);
	}
	...
	[Fact(DisplayName = "unit/regression/coerce_set_to_array_2.mzn")]
	...
	[Fact(DisplayName = "unit/regression/error_in_comprehension.mzn")]
	...
	[Fact(DisplayName = "unit/regression/float_div_crash.mzn")]
	public void test_unit_regression_float_div_crash() {
		var path = "unit/regression/float_div_crash.mzn";
		Test(path);
	}

	[Fact(DisplayName = "unit/regression/float_mod_crash.mzn")]
	...
	public void test_unit_regression_github_779() {
	...
	[Fact(DisplayName = "unit/regression/test_bug67.mzn")]
	public void test_unit_regression_test_bug67() {
		var path = "unit/regression/test_bug67.mzn";
		Test(path);
	}
	...
	public void test_unit_types_array_var_opt_set_comprehension() {
		var path = "unit/types/array_var_opt_set_comprehension.mzn";
		Test(path);
	}

	[Fact(DisplayName = "unit/types/comprehension_of_absent_any_1.mzn")]
	public void test_unit_types_comprehension_of_absent_any_1() {
	...
	public void test_unit_types_var_opt_set_if_then_else() {
	...
	[Fact(DisplayName = "unit/globals/global_cardinality/globals_global_cardinality_low_up_opt.mzn")]
	...
	[Fact(DisplayName = "unit/globals/global_cardinality/globals_global_cardinality_low_up_set.mzn")]
	...
	[Fact(DisplayName = "unit/globals/global_cardinality_closed/globals_global_cardinality_closed.mzn")]
	...
	[Fact(DisplayName = "unit/globals/global_cardinality_closed/globals_global_cardinality_closed_opt.mzn")]
	...
	[Fact(DisplayName = "unit/globals/global_cardinality_closed/globals_global_cardinality_closed_set.mzn")]
	...
	[Fact(DisplayName = "unit/globals/global_cardinality_closed/globals_global_cardinality_low_up_closed.mzn")]
	public void test_unit_globals_global_cardinality_closed_globals_global_cardinality_low_up_closed() {
		var path = "unit/globals/global_cardinality_closed/globals_global_cardinality_low_up_closed.mzn";
		Test(path);
	}

	[Fact(DisplayName = "unit/globals/global_cardinality_closed/globals_global_cardinality_low_up_closed_opt.mzn")]
	...
	[Fact(DisplayName = "unit/globals/global_cardinality_closed/globals_global_cardinality_low_up_closed_set.mzn")]
	...
	[Fact(DisplayName = "unit/globals/roots/roots_bad.mzn")]
