public class ClientIntegrationTests : IClassFixture<ClientFixture>
{
    ...
    public async void test_unit_compilation_multiple_neg(string solver)
    {
        ...
        var options = SolveOptions.Create(solverId: solver);
        await foreach (var solution in _client.Solutions(model, options))
        {
            solution.Status.Should().Be(SolveStatus.Satisfied);
        }
    }
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async void test_unit_globals_global_cardinality_globals_global_cardinality_low_up_set(
        string solver
    )
    {
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async void test_unit_globals_global_cardinality_globals_global_cardinality_opt(
        string solver
    )
    {
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async void test_unit_globals_global_cardinality_globals_global_cardinality_set(
        string solver
    )
    {
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async void test_unit_globals_global_cardinality_closed_globals_global_cardinality_closed_opt(
        string solver
    )
    {
        var path =
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async void test_unit_globals_global_cardinality_closed_globals_global_cardinality_closed_set(
        string solver
    )
    {
        var path =
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async void test_unit_globals_global_cardinality_closed_globals_global_cardinality_low_up_closed_opt(
        string solver
    )
    {
        var path =
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async void test_unit_globals_global_cardinality_closed_globals_global_cardinality_low_up_closed_set(
        string solver
    )
    {
        var path =
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async void test_unit_globals_value_precede_chain_globals_value_precede_chain_int(
        string solver
    )
    {
    ...
    [Theory(
        DisplayName = "unit/globals/value_precede_chain/globals_value_precede_chain_int_opt.mzn"
    )]
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async void test_unit_globals_value_precede_chain_globals_value_precede_chain_int_opt(
        string solver
    )
    {
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async void test_unit_globals_value_precede_chain_globals_value_precede_chain_set(
        string solver
    )
    {
