...
public class ClientIntegrationTests : IClassFixture<ClientFixture>
{
    ...
    MiniZincModel Compile(string path)
    {
        Write(path);
        WriteSection();
        var model = MiniZincModel.FromFile(path);
    ...
    async Task<MiniZincResult> Solve(
        MiniZincModel miniZincModel,
        SolveOptions options,
        params SolveStatus[] statuses
    )
    {
        var solution = await MiniZinc.Solve(miniZincModel, options);
    ...
    public async Task test_solve_unit_general_array_access_out_of_bounds_1()
    {
        ...
        solution
            .Text.Should()
            .MatchRegex(
                ".*array access out of bounds, array `x' has index set A..B, but given index is C.*"
            );
    }
    ...
    public async Task test_solve_unit_general_enum_out_of_range_1()
    {
        ...
        solution
            .Text.Should()
            .MatchRegex(".*declared domain of `x' is {A}, but assigned value is B.*");
    }
    ...
    public async Task test_solve_unit_general_function_param_out_of_range()
    {
        ...
        solution
            .Text.Should()
            .MatchRegex(
                ".*declared domain of `'<unnamed argument>'' is 1..1, but assigned value is 2.*"
            );
    }
    ...
    public async Task test_solve_unit_general_function_return_out_of_range()
    {
        ...
        solution
            .Text.Should()
            .MatchRegex(".*result of function `foo' is B, which violates function type-inst {A}.*");
    }
    ...
    public async Task test_solve_unit_general_function_return_out_of_range_opt()
    {
        ...
        solution
            .Text.Should()
            .MatchRegex(
                ".*function result violates function type-inst, array contains value B which is not contained in {A}.*"
            );
    }
    ...
    public async Task test_solve_unit_general_param_out_of_range_float()
    {
        ...
        solution
            .Text.Should()
            .MatchRegex(
                ".*declared domain of `x' is -infinity..-1.0 union 1.0..infinity, but assigned value is 0.0.*"
            );
    }
    ...
    public async Task test_solve_unit_general_param_out_of_range_int()
    {
        ...
        solution
            .Text.Should()
            .MatchRegex(
                ".*declared domain of `x' is -infinity..-1 union 1..infinity, but assigned value is 0.*"
            );
    }
    ...
    public async Task test_solve_unit_regression_github_648_par_array_decl()
    {
        ...
        solution
            .Text.Should()
            .MatchRegex(".*declared domain of `x[1]' is 1..3, but assigned value is 0.*");
    }
    ...
    public async Task test_solve_unit_regression_github_648_par_decl()
    {
        ...
        solution
            .Text.Should()
            .MatchRegex(".*declared domain of `x' is 1..3, but assigned value is 0.*");
    }
    ...
    public async Task test_solve_unit_types_nested_type_inst_id()
    {
        ...
        solution
            .Text.Should()
            .MatchRegex(".*type-inst variable $X used in both array and non-array position.*");
    }
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async Task test_solve_unit_globals_alldifferent_except_0_test_alldiff_except0b(
        string solver
    )
    {
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async Task test_solve_unit_globals_bin_packing_capa_globals_bin_packing_capa(
        string solver
    )
    {
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async Task test_solve_unit_globals_global_cardinality_globals_global_cardinality_low_up_set(
        string solver
    )
    {
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async Task test_solve_unit_globals_global_cardinality_globals_global_cardinality_opt(
        string solver
    )
    {
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async Task test_solve_unit_globals_global_cardinality_globals_global_cardinality_set(
        string solver
    )
    {
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async Task test_solve_unit_globals_global_cardinality_closed_globals_global_cardinality_closed_opt(
        string solver
    )
    {
        var path =
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async Task test_solve_unit_globals_global_cardinality_closed_globals_global_cardinality_closed_set(
        string solver
    )
    {
        var path =
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async Task test_solve_unit_globals_global_cardinality_closed_globals_global_cardinality_low_up_closed_opt(
        string solver
    )
    {
        var path =
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async Task test_solve_unit_globals_global_cardinality_closed_globals_global_cardinality_low_up_closed_set(
        string solver
    )
    {
        var path =
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async Task test_solve_unit_globals_value_precede_globals_value_precede_int_opt(
        string solver
    )
    {
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async Task test_solve_unit_globals_value_precede_chain_globals_value_precede_chain_int(
        string solver
    )
    {
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async Task test_solve_unit_globals_value_precede_chain_globals_value_precede_chain_int_opt(
        string solver
    )
    {
    ...
    [InlineData("gecode")]
    [InlineData("chuffed")]
    public async Task test_solve_unit_globals_value_precede_chain_globals_value_precede_chain_set(
        string solver
    )
    {
